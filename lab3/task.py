...
def create_empty_files():
    ...
    filenames = ['Сікорський1.txt', 'Сікорський2.txt', 'Сікорський3.txt']
...
def encrypt_decrypt_file(is_encrypt):
    ...
    file1_path = filedialog.askopenfilename(title="Виберіть Сікорський1.txt", filetypes=[("Text files", "*.txt")])
    file2_path = filedialog.askopenfilename(title="Виберіть Сікорський2.txt", filetypes=[("Text files", "*.txt")])
